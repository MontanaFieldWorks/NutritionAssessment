  ...
  return (
    <div className="min-h-screen bg-white text-black font-sans selection:bg-blue-100 selection:text-blue-900">
            ...
            <div className="bg-white text-black rounded-2xl p-6 md:p-8 border border-gray-250 shadow-sm">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-gray-200">
                <div className="space-y-1">
                  <h2 className="text-xl md:text-2xl font-black tracking-tight mt-1 text-slate-900">
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="flex items-center gap-2 font-bold text-sm bg-slate-900 text-white px-6 py-3 rounded-xl hover:bg-slate-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-md cursor-pointer"
                  >
                    {isAnalyzing ? (
                      <>
              ...
              {activeAnalysis ? (
                <div className="mt-6 grid grid-cols-1 md:grid-cols-12 gap-8 animate-in fade-in slide-in-from-top-4 duration-300">
                  ...
                  <div className="md:col-span-12 lg:col-span-7 space-y-6">
                    ...
                    <div className="bg-gray-50 p-5 rounded-xl border border-gray-200 flex flex-col">
                      ...
                      <textarea
                        ...
                        className="w-full bg-transparent border-none text-slate-950 text-sm leading-relaxed italic focus:ring-1 focus:ring-slate-900 focus:outline-none rounded p-1 resize-y min-h-[140px] cursor-text"
                  ...
                  <div className="md:col-span-12 flex justify-end gap-2 text-xs text-slate-500 font-semibold pt-4 border-t border-gray-200">
      ...
      <section className="hidden print:block bg-white text-slate-900 p-8 min-h-screen">
        ...
        <div className="bg-white min-h-screen flex flex-col justify-between" style={{ pageBreakAfter: "always", breakAfter: "page" }}>
          <div>
            ...
            <div className="border-b-4 border-slate-900 pb-4 flex items-center justify-between">
              <div>
                ...
                <h1 className="text-2xl font-black text-slate-900 tracking-tight mt-1">
                  SharpeFN Client Nutrition Analysis: {activeClient.name} week of {getMondayDateText()}
                </h1>
              ...
              <div className="text-right">
                ...
                <span className="text-[10px] text-gray-500 block mt-1">Generated: Jun 12, 2026</span>
              </div>
            </div>

            {/* Client Core Metrics row */}
            <div className="grid grid-cols-4 gap-4 py-4 border-b border-gray-200 text-xs mb-4">
              <div>
                <span className="text-[10px] font-bold text-gray-400 uppercase block">CLIENT NAME</span>
                <strong className="text-base text-slate-950 block">{activeClient.name}</strong>
              </div>
              <div>
                <span className="text-[10px] font-bold text-gray-400 uppercase block">CURRENT WEIGHT</span>
                <strong className="text-base text-slate-950 block">{activeClient.weight} lbs</strong>
              </div>
              <div>
                <span className="text-[10px] font-bold text-gray-400 uppercase block">CALORIE PROTOCOL</span>
                <strong className="text-base text-slate-950 block capitalize">{activeClient.goalType.toUpperCase().replace("_", " ")}</strong>
              </div>
              <div>
                <span className="text-[10px] font-bold text-gray-400 uppercase block">ESTIMATED TDEE</span>
                <strong className="text-base text-slate-950 block">{activeClient.tdee} kcal</strong>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-4 text-xs">
              ...
              <div className="border border-gray-205 rounded-xl p-4 bg-white flex flex-col justify-between">
                <div>
                  <h3 className="text-xs font-black text-slate-900 uppercase tracking-wider mb-1 border-b pb-1.5 flex justify-between items-center">
                    <span>Macro Distribution</span>
                    <span className="text-[9px] font-bold text-gray-400 uppercase tracking-widest">Actual vs Target</span>
                  </h3>
                  
                  <div className="h-[140px] my-2">
                    <BarChart width={310} height={135} data={macroDistributionData} margin={{ top: 10, right: 10, left: -25, bottom: 0 }}>
                      <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#f1f5f9" />
                      <XAxis dataKey="name" stroke="#64748b" fontSize={10} tickLine={false} />
                      <YAxis stroke="#64748b" fontSize={10} tickLine={false} />
                      <Bar dataKey="Actual" fill="#3b82f6" name="Actual" radius={[2, 2, 0, 0]} barSize={26} />
                      <Bar dataKey="Goal" fill="#9ca3af" name="Goal" radius={[2, 2, 0, 0]} barSize={26} />
                    </BarChart>
                  </div>
                </div>
                
                <table className="w-full text-left text-[11px] border border-gray-150 mt-1">
                  <thead className="bg-[#f8fafc] text-slate-700 font-extrabold uppercase text-[9px] tracking-wider border-b border-gray-200">
                    <tr>
                      <th className="py-1 px-2">Macro</th>
                      <th className="py-1 px-2">Actual Avg</th>
                      <th className="py-1 px-2">Target Goal</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-100 font-semibold text-slate-800">
                    <tr>
                      <td className="py-1 px-2 flex items-center gap-1"><span className="h-2 w-2 rounded-full bg-[#3b82f6]"></span> Protein</td>
                      <td className="py-1 px-2">{averageProtein}g ({averageProteinPct}%)</td>
                      <td className="py-1 px-2">{activeClient.proteinGoal}g ({goalProteinPct}%)</td>
                    </tr>
                    <tr>
                      <td className="py-1 px-2 flex items-center gap-1"><span className="h-2 w-2 rounded-full bg-[#00c950]"></span> Carbs</td>
                      <td className="py-1 px-2">{averageCarbs}g ({averageCarbsPct}%)</td>
                      <td className="py-1 px-2">{activeClient.carbsGoal}g ({goalCarbsPct}%)</td>
                    </tr>
                    <tr>
                      <td className="py-1 px-2 flex items-center gap-1"><span className="h-2 w-2 rounded-full bg-[#f0b100]"></span> Fat</td>
                      <td className="py-1 px-2">{averageFat}g ({averageFatPct}%)</td>
                      <td className="py-1 px-2">{activeClient.fatGoal}g ({goalFatPct}%)</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div className="border border-gray-205 rounded-xl p-4 bg-white flex flex-col justify-between">
                <div>
                  <h3 className="text-xs font-black text-slate-900 uppercase tracking-wider mb-1 border-b pb-1.5 flex justify-between items-center">
                    ...
                    <span className="text-[9px] font-bold text-gray-400 uppercase tracking-widest">Energy Split</span>
                  </h3>
                  
                  <div className="h-[140px] my-2">
                    <BarChart width={310} height={135} data={dailyCaloriesData} margin={{ top: 15, right: 10, left: -25, bottom: 0 }}>
                      <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#f1f5f9" />
                      <XAxis dataKey="date" tick={{ fontSize: 9, fill: "#64748b" }} tickLine={false} />
                      <YAxis tick={{ fontSize: 9, fill: "#64748b" }} tickLine={false} />
                      <ReferenceLine y={activeClient.goalCalories} stroke="#ef4444" strokeDasharray="5 5" />
                ...
                <div className="grid grid-cols-3 text-center text-[10px] font-bold gap-1 mt-1 bg-gray-50 border border-gray-150 p-2 rounded-lg">
                  <div>
                    <span className="text-blue-600 block uppercase text-[8px]">PROTEIN</span>
                    <span className="text-slate-800">4 kcal/g</span>
                  </div>
                  <div>
                    <span className="text-emerald-600 block uppercase text-[8px]">CARBOHYDRATE</span>
                    <span className="text-slate-800">4 kcal/g</span>
                  </div>
                  <div>
                    <span className="text-amber-600 block uppercase text-[8px]">LIPIDS / FAT</span>
                    <span className="text-slate-800">9 kcal/g</span>
                  </div>
                </div>
              </div>
              ...
              <div className="border border-gray-205 rounded-xl p-4 bg-white flex flex-col justify-between">
                <div>
                  <h3 className="text-xs font-black text-slate-900 uppercase tracking-wider mb-2 border-b pb-1">Totals by Day</h3>
                  <table className="w-full text-left text-[11px]">
                    <thead className="bg-[#f8fafc] text-slate-700 font-extrabold uppercase text-[9px] tracking-wider border-b border-gray-205">
                      <tr>
                        <th className="py-1 px-1.5">Date</th>
                        <th className="py-1 px-1.5">Prot</th>
                        <th className="py-1 px-1.5">Carb</th>
                        <th className="py-1 px-1.5">Fat</th>
                        <th className="py-1 px-1.5">Calories</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-100 font-semibold text-slate-800">
                      {clientJournal.map((day) => (
                        <tr key={day.date}>
                          <td className="py-1 px-1.5">{day.date}</td>
                          <td className="py-1 px-1.5 text-blue-600 font-bold">{day.protein}g</td>
                          <td className="py-1 px-1.5 text-emerald-600 font-bold">{day.carbs}g</td>
                          <td className="py-1 px-1.5 text-amber-600 font-bold">{day.fat}g</td>
                          <td className="py-1 px-1.5 font-bold text-slate-950">{day.calories} kcal</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
              ...
              <div className="border border-gray-205 rounded-xl p-4 bg-gray-50 flex flex-col justify-between">
                <div>
                  <h3 className="text-xs font-black text-slate-900 uppercase tracking-wider mb-1 border-b pb-1.5 flex justify-between items-center">
                  ...
                  <div className="space-y-2 text-[11px] font-semibold text-slate-700 mt-3">
                ...
                <div className="text-[10px] text-gray-500 bg-white border border-gray-150 rounded-lg p-2.5 leading-relaxed mt-3 italic text-center font-medium">
                  "Variance is calculated as the rolling actual logged calorie average minus target metabolic protocol guidelines."
                </div>
              </div>
          ...
          {/* Footer for Page 1 */}
          <div className="pt-3 border-t border-gray-200 flex justify-between items-center text-[10px] text-gray-400 font-semibold uppercase">
        ...
        <div className="bg-white min-h-screen flex flex-col justify-between pt-4" style={{ pageBreakBefore: "always", breakBefore: "page" }}>
          <div>
            {/* Printable Report Header */}
            <div className="border-b-4 border-slate-900 pb-4 flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-slate-500 font-bold uppercase tracking-wider mt-1">Professional Client Feedback dossier</p>
              </div>
              <div className="text-right">
                <span className="text-xs font-bold text-gray-400 uppercase tracking-wider block">PREPARED FOR</span>
                <span className="text-sm font-black text-slate-900">{activeClient.name}</span>
                <span className="text-[10px] text-gray-500 block mt-1">Week of Monday: {getMondayDateText()}</span>
              </div>
            </div>
            ...
            {activeAnalysis ? (
              <div className="space-y-6 mt-6">
                ...
                <div className="bg-gray-50 p-6 border-l-4 border-emerald-500 rounded-r-lg">
                  <h4 className="text-[10px] font-bold text-emerald-700 uppercase tracking-widest mb-1.5">Weekly Summary Review</h4>
                  <p className="text-xs text-slate-850 italic leading-relaxed font-semibold">
                    "{activeAnalysis.coachingSummary}"
                  </p>
                </div>

                {/* Side by side columns layout for written analysis */}
                <div className="grid grid-cols-2 gap-8 text-xs leading-relaxed text-slate-800 mt-6">
                  <div className="space-y-6">
                    <div className="border border-gray-205 rounded-xl p-4 bg-white shadow-xs">
                      <h4 className="font-extrabold text-slate-900 uppercase text-[10px] tracking-widest mb-2 border-b pb-1 flex items-center gap-1.5">
                        <span className="h-1.5 w-1.5 bg-blue-500 rounded-full"></span> Macronutrient Distribution Audit
                      </h4>
                      <p className="text-slate-650 text-[11px] leading-relaxed whitespace-pre-wrap">{activeAnalysis.macroBreakdownFeedback}</p>
                    </div>
                    ...
                    <div className="border border-gray-205 rounded-xl p-4 bg-white shadow-xs">
                      ...
                      <p className="text-slate-650 text-[11px] leading-relaxed whitespace-pre-wrap">{activeAnalysis.calorieAssessment}</p>
                    </div>
                  </div>

                  <div className="space-y-6">
                    <div className="border border-gray-205 rounded-xl p-4 bg-white shadow-xs">
                      <h4 className="font-extrabold text-[#3b82f6] uppercase text-[10px] tracking-widest mb-3 border-b pb-1 flex items-center gap-1.5">
                        <span className="h-1.5 w-1.5 bg-blue-600 rounded-full"></span> Targeted Coaching Action Bullets
                      </h4>
                      <ul className="space-y-2 list-decimal list-inside pl-1 text-[11px] text-slate-700 font-medium">
                    ...
                    <div className="border border-gray-205 rounded-xl p-4 bg-white shadow-xs">
                      <h4 className="font-extrabold text-emerald-700 uppercase text-[10px] tracking-widest mb-3 border-b pb-1 flex items-center gap-1.5">
                        <span className="h-1.5 w-1.5 bg-emerald-600 rounded-full"></span> Smart High-Nutrient Substitutions
                      </h4>
                      <ul className="space-y-2 list-disc list-inside pl-1 text-[11px] text-slate-700 font-medium">
                        {activeAnalysis.menuSuggestions.map((sub, idx) => (
                          <li key={idx} className="leading-relaxed">{sub}</li>
                        ))}
                      </ul>
                    </div>
                  </div>
